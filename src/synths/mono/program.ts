/*
 * Korg monologue program init + serialization: makeProgramCodec bound to the
 * monologue param table. Serialization is by stable param key so saved
